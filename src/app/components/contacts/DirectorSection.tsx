          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6 reveal-director transition-all duration-700" style={{ transitionDelay: '200ms' }}>
              <div>
                ...
                <p className="text-gray-500 text-lg mt-1">Chief Executive Officer(CEO)</p>
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  <span className="bg-orange-100 text-orange-600 text-xs px-3 py-1 rounded-full">
                    <i className="fas fa-trophy"></i> 8+ Years Experience
                  </span>
            ...
            <div className="lg:w-1/2 director-img-wrapper rounded-3xl shadow-2xl reveal-director transition-all duration-700 relative" style={{ transitionDelay: '100ms' }}>
              <div className="relative w-full h-80 md:h-[450px] lg:h-[500px]">
                <Image
                  ...
                  alt="Khalid Ramadhan - Operations Director"
                  fill
              ...
              <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-md rounded-xl px-4 py-2 shadow-lg">
                ...
                <p className="text-gray-800 font-semibold text-sm">"Excellence in every detail"</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 director-img-wrapper rounded-3xl shadow-2xl reveal-director transition-all duration-700 relative" style={{ transitionDelay: '100ms' }}>
              <div className="relative w-full h-80 md:h-[450px] lg:h-[500px]">
                <Image
                  src="/images/kb.jpeg"
                  alt="Kaniki Athumani - Founder & Managing Director"
                  fill
                  className="object-cover object-top rounded-3xl"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  priority
              ...
              <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-md rounded-xl px-4 py-2 shadow-lg">
                <i className="fas fa-quote-left text-orange-500 text-xl"></i>
                <p className="text-gray-800 font-semibold text-sm">"Building Tanzania's future"</p>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 space-y-6 reveal-director transition-all duration-700" style={{ transitionDelay: '200ms' }}>
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  <span className="bg-orange-100 text-orange-600 text-xs px-3 py-1 rounded-full">
                    <i className="fas fa-trophy"></i> 12+ Years Experience
                  </span>
                  <span className="bg-green-100 text-green-600 text-xs px-3 py-1 rounded-full">
                    <i className="fas fa-check-circle"></i> 45+ Projects
                  </span>
                  <span className="bg-blue-100 text-blue-600 text-xs px-3 py-1 rounded-full">
